...
Plugin URI: https://learndash.com/add-on/learndash-achievements
LD Requires at least: 3.0
Slug: learndash-achievements
Tags: achievements, gamification, awards
Requires at least: 5.0
Tested up to: 6.1.1
Requires PHP: 7.0
Stable tag: 1.2

Create an awards program with achievements including badges awarded based on a number of both WordPress and LearnDash triggers.
...
* Added - Badge descriptions on leaderboard
* Fix - Re-enable points system on leaderboard
* Fix - Earned points not calculating correctly

= 1.1.1 =

* Added LearnDash 4.0 compatibility
* Updated achievements leaderboard Gutenberg block
* Fixed ability to set badge sizes
* Fixed poost and page visiting logic for user visits post and user visits page triggers
* Fixed quiz achievement trigger 
* Fixed remove badges when an achievement is deleted
