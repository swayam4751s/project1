...
class ShortcodePro
{
    ...
    function bp3dviewer_cpt_content_func($atts)
    {
        ...
        $skybox_image = $data['bp_3d_skybox_image'] ?? null;
        ...
        $finalData = [
            ...
            "model" => [
                "modelUrl" => $modelSrc,
                "poster" => $poster,
                "skyboxImage" => $skybox_image,
                'arEnabled' => $data['bp_3d_enable_ar'] === '1',
                'modelISOSrc' => $data['model_iso_src'],
            ],
            "O3DVSettings" =>  [
...
<?php
            wp_enqueue_script('bbp3d-public');
            wp_enqueue_style('bp3d-custom-style');
            wp_enqueue_style('bp3d-public');
        }
