...
function bp3d_enqueue_custom_admin_style() {
    ...
    if($post_type === 'bp3d-model-viewer' || $screen->base === 'bp3d-model-viewer_page_bp3d-support'){
                ...
                <div class="col col-12">
                    <div class="bplugins-feature center">
                        <div style="background:white;overflow:hidden;">
                            ...
                            <div class="bp3dv_affiliate_link">
                                <a href="<?php echo esc_url(admin_url('edit.php?post_type=bp3d-model-viewer&page=3d-viewer-affiliation')) ?>">
                                    <img src="<?php echo esc_url(BP3D_DIR.'/admin/images/affiliate-ad.png') ?>" alt="" >
                                </a>
                            </div>
                        </div>   
                    </div>
